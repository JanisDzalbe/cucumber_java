...
public class SampleSteps {
    ...
    @Then("^I see feedback inputs:$")
    public void iSeeFeedbackInputs(Map <String, String> valuesToEnter) throws Throwable {
        assertEquals(valuesToEnter.get("name"),
                driver.findElement(By.id("name")).getText());
        assertEquals(valuesToEnter.get("age"),
                driver.findElement(By.id("age")).getText());
        assertEquals(valuesToEnter.get("gender"),
                driver.findElement(By.id("gender")).getText());
    }
